...
md_lines <- c(
  ...
  "",
  sprintf(paste0("Williams' λ = -0.286, ours = %s. Both our OLS coefficients ",
                 "and our |λ| sit ~14-37%% below Williams, so they largely ",
                 "cancel in the implied γ = OLS/|λ|."), fmt(spec6_lambda$est)),
  ...
  "",
  sprintf(paste0("1. **|λ| is about 37%% below Williams** (our %s vs −0.286). ",
                 "Our OLS"), fmt(spec6_lambda$est)),
